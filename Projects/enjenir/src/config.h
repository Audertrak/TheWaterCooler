...
// Debugging Macros
  ...
  #define TODO(message) TraceLog(LOG_WARNING, "TODO: %s [%s in %s]", message, AT_FILE_LINE, __func__)
  #define STUB(message) TraceLog(LOG_DEBUG, "STUB: %s [%s in %s]", message, AT_FILE_LINE, __func__)
#else
  #define TODO(message)                                                         \
